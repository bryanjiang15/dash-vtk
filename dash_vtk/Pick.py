...
- vtkClassState (dict; default {  radius: 0.05,  center: [0, 0, 0],})"""
    ...
    def __init__(
        ...
        vtkClassState: typing.Optional[dict] = None,
        axisIds: typing.Optional[typing.Sequence[NumberType]] = None,
        offsets: typing.Optional[typing.Sequence[NumberType]] = None,
        **kwargs
    ):
...
setattr(Pick, "__init__", _explicitize_args(Pick.__init__))
